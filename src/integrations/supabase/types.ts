  ...
  public: {
    Tables: {
      ...
      solicitacoes_vendedor: {
        ...
        Relationships: [
          {
            foreignKeyName: "solicitacoes_vendedor_analisado_por_fkey";
    ...
    Functions: {
      ...
      aprovar_vendedor: { Args: { p_user_id: string }; Returns: undefined };
      ...
      receber_estoque_produto: {
        Args: {
          p_atualizar_custo?: boolean;
          p_produto_id: string;
          p_quantidade: number;
          p_valor_custo?: number | null;
        };
        Returns: undefined;
      };
      registrar_pagamento_fiado: {
        Args: {
          ...
          p_valor: number;
          p_venda_id?: string | null;
        };
        Returns: string;
      };
      rejeitar_vendedor: {
        Args: { p_observacao?: string | null; p_user_id: string };
        Returns: undefined;
      };
    };
    Enums: {
